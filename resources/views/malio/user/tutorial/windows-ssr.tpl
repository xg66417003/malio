<!DOCTYPE html>
<html lang="en">
 {if $i18n->lang == 'en'}<head>
  {include file='user/head.tpl'}

  <title>Windows tutorial &mdash; {$config["appName"]}</title>
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div id="checkin-div" class="breadcrumb-item active">
                <a href="/user/tutorial?os=windows&client=netch" class="btn btn-icon icon-left btn-primary {if $malio_config['display_more_app_button'] == true}mr-2{/if}"><i class="fas fa-gamepad"></i> Game acceleration tutorial</a>
              </div>
              {/if}
              ...
              <div class="col-12">
                ...
                <div class="alert alert-warning alert-has-icon">
                  ...
                  <div class="alert-body">
                    <div class="alert-title">This client cannot be used</div>
                    Your encryption, obfuscation, and protocol are not compatible with SSR clients.
If you need to use it, please do so at <a href="/user/edit"><u>Connection Settings</u></a> The page changes Encryption Mode, Obfuscation and Protocol to be options that SSR can connect to.
                  </div>
                </div>
                {/if}
                <div class="card">
                      ...
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>Download the SSR client, unzip and run as an administrator ShadowsocksR-dotnet4.0.exe。If prompted to install .NET Framework，please<a href="https://www.microsoft.com/net/download/dotnet-framework-runtime" target="blank">Click here to</a>Visit the Microsoft website to download the installation。</p>
                            <a href="/client-download/ssr-win.7z" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> Download client</a>
                          </div>
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="##" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" onclick="importSublink('ssr')"><i class="malio-ssr"></i> One click import subscription link to SSR</a>
                            <p class="text-muted" style="font-size: 13px">One key import failed？<a href="#manual-import" class="text-muted "><u>Try manual import</u> →</a></p>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>Right click small plane again and select "server subscribe" > "update SSR server subscription (without proxy)"</p>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>Right-click on the small plane and select "Server.” > “{$config['appName']}”，You can switch nodes at will. After selecting the node, it can be used normally。</p>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                    ...
                    <div class="faq">
                      <div class="row mt-2 mb-2">
                        <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6" id="manual-import">
                          <h6>SSR Cannot import with one key. How to import configuration manually?</h6>
                          <p class="mb-4 font-13">
                            <a href="##" class="copy-text" data-clipboard-text="{$subInfo['ssr']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}">Click here to copy the SSR subscription link</a>，Find the small plane in the status bar, right-click, select "server subscription" > "SSR server subscription Settings", and add and paste subscription links.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <a href="/client-download/ssr-win.7z" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic hide-on-mobie">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/windows-ssr-1.jpg">
