...
<head>
  ...
  <title>iOS tutorial &mdash; {$config["appName"]}</title>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            {if $malio_config['enable_ios_apple_id'] == true}
                              <p>Download the US Apple ID client provided by logging into the website in the App Store。<br>
                                In order to protect your privacy, please do not log in directly in the phone Settings, just log in the App Store。
                              </p>
                              {if $user->class>0}
                              <p>Apple ID：<a class="copy-text" data-clipboard-text="{$malio_config['ios_apple_id']}" href="##">{$malio_config['ios_apple_id']}</a><br>
                                password：<a class="copy-text" data-clipboard-text="{$malio_config['ios_apple_id_password']}" href="##">********(copy)</a></p>
                              {else}
                              <p>After purchasing the membership plan, refresh this page to see what is available for free Apple ID。</p>
                              {/if}
                            {else}
                              <p>This is a paid software, you need to buy to use。</p>
                            {/if}
                            <a href="https://apps.apple.com/us/app/shadowrocket/id932747118" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fab fa-apple"></i> open App Store download</a>
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>Click on this button 👇👇👇，Automatically jumps to add a subscription。</p>
                            ...
                            <p class="text-muted" style="font-size: 13px">一Key import failed？<a href="#manual-import" class="text-muted "><u>Key import unsuccessful try manual import</u> →</a></p>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>Click configuration in the bottom bar, select Add configuration, paste configuration link, and download.
Then click on the newly added profile address in the remote file and select the second from the pop-up menu「Using a configuration」，this moment APP It will automatically start downloading the configuration and apply it.
Go back to the homepage and click enter「The global routing」Change it to configuration。</p>
                      ...
                      <li>
                        ...
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>Click the home page of the bottom column, select a node at will, and open the switch at the top to enable it。</p>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/blank-blue.jpg">
                    ...
                    <div class="faq">
                      <div class="row mt-2">
                        <div id="manual-import" class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                          <h6>Shadowrocket Cannot import with one key. How to import configuration manually？</h6>
                          <p class="mb-4 font-13">
                            <a href="##" class="copy-text" data-clipboard-text="{$subInfo['shadowrocket']}{if $malio_config['enable_sub_extend'] == true}&extend=1{/if}">Click here to copy Shadowrocket Subscribe to the link</a>，open Shadowrocket home，Click the plus sign in the top right corner and click on the first line again「type 」，select Subscribe。in 「remark 」In the input{$config['appName']}，Then, in「URL」Paste the subscription link in。
                          </p>
                        </div>
                        <div class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                          <h6>Shadowrocket How to update nodes？</h6>
                          <p class="mb-4 font-13">
                            Find the name on the home page{$config['appName']}To subscribe to the server, click the one on the right ⓘ ，Click on the top right corner to finish.
We recommend that users turn on the auto-update switch and click on the navigation bar at the bottom「setting」Go to the Settings page, then scroll down tothe very bottom，enter into「Server subscription」subpage。will 「Update on open」Switch on。
                          </p>
                        </div>
                      </div>
                    </div>
