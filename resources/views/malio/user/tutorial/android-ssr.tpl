...
<html lang="en">
 {if $i18n->lang == 'en'}<head>
  ...
  <title>Android tutorial  &mdash; {$config["appName"]}</title>
                    ...
                    <ul class="steps">
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            ...
                            <p>Download the SSR client。</p>
                            <a href="/client-download/laowhy.apk" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> Download client</a>
                          </div>
                      ...
                      <li>
                        ...
                        <div class="row">
                          ...
                          <p>Open the software login account and click the node to select a node connection!。
                      ...
                      <li>
                        <div class="row">
                          <div class="left-text col-xs-12 col-md-6 col-lg-6">
                            <label class="step-no">1.</label>
                            <p>下载 SSR 客户端。</p>
                            <a href="/client-download/laowhy.apk" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                          </div>
                          <div class="right-pic col-xs-12 col-md-6 col-lg-6">
                            <div class="tutorial-pic hide-on-mobie">
                              <img style="border:1px solid #f0f0f0" src="/theme/malio/img/tutorial/blank-red.jpg">
